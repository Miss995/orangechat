...
class SettingsStore(
    ...
    companion object {
        ...
        // 请求编辑模式（发送前手动控制上下文）
        val REQUEST_EDIT_MODE = booleanPreferencesKey("request_edit_mode")
    }
    ...
    val settingsFlowRaw = dataStore.data
        .catch { exception ->
            ...
            Settings(
                ...
                requestEditMode = preferences[REQUEST_EDIT_MODE] == true,
            )
        }
        .map {
    ...
    suspend fun update(settings: Settings) {
        ...
        dataStore.edit { preferences ->
            ...
            preferences[REQUEST_EDIT_MODE] = settings.requestEditMode
        }
    }
...
data class Settings(
    ...
    val requestEditMode: Boolean = false,
) {
    companion object {
